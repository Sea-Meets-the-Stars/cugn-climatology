...
This repository will generate climatologies for the California Underwater Glider Network (CUGN).  
...
1. Please update the basic CLAUDE.md file for this project.  Have it indicate:
